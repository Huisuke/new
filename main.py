...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Bomberman Hui")
    ...
    def play(self):
        ...
        while True:
            ...
            # Update sprites
            if not self.paused:
                self.allplayers.update(self.stick, self.allhards, self.allsofts, self.allbombs, self.allexplosions, self.free_tiles, dt)
                self.allbombs.update(self.allhards, self.allsofts, self.allexplosions, self.free_tiles)
